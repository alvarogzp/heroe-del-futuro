...
public class HeroeDelFuturo extends MIDlet implements CommandListener,ItemStateListener {
	...
	public HeroeDelFuturo() {
		...
		volumenCommand=new Command("Volumen",Command.SCREEN,2);
		modoCommand=new Command("Modo de juego",Command.SCREEN,3);
		...
		StringItem[] texto=new StringItem[10];
		texto[0]=new StringItem("","Nave:");
		texto[1]=new StringItem("","--Izquierda: Tecla izquierda o 4");
		texto[2]=new StringItem("","--Derecha: Tecla derecha o 6");
		texto[3]=new StringItem("","--Arriba: Tecla arriba o 2");
		texto[4]=new StringItem("","--Abajo: Tecla abajo o 8");
		texto[5]=new StringItem("","--Disparar: Tecla fuego o 5");
		texto[6]=new StringItem("","--Cambiar de arma: Tecla GAME C (* o 7)");
		texto[7]=new StringItem("","Otros controles:");
		texto[8]=new StringItem("","--Poner sonido en mute: Tecla GAME D (# o 9)");
		texto[9]=new StringItem("","--Menú: Tecla de navegación izquierda o derecha");
		int i;
		for (i=0 ; i<=9 ; i++) {
			controles.append(texto[i]);
		}
