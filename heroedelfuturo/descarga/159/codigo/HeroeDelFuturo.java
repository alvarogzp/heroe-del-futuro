...
public class HeroeDelFuturo extends MIDlet implements CommandListener,ItemStateListener,Runnable {
	...
	public void itemStateChanged(Item elemento) {
		if (elemento == volumenMusica) {
			...
			screen.setVolumen(0,i);
			screen2.setVolumen(0,i);
			screen3.setVolumen(0,i);
		}

		if (elemento == volumenEfectos) {
			int i=volumenEfectos.getValue()*10;
			screen.setVolumen(1,i);
			screen2.setVolumen(1,i);
			screen3.setVolumen(1,i);
		}
	}
