...
class Level3 extends GameCanvas {
	...
	private boolean cargandoActivo,tiempoFinOn,muerto,tecla,pausa,dobleDisparo,teclaIzquierda,teclaDerecha,teclaArriba,teclaAbajo,tiles,gameCpress,superDisparo,gameDpress,cargarSonido;
