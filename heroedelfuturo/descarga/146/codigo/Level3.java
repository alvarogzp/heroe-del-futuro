...
class Level3 extends GameCanvas {
    ...
    private int finishLevel,cicloCount,cicloEspera,heroBullets,monsterLives,tiempoFin,volumenMusica,volumenEfectos,sleepTimeStatic,pLenght,scoreLevel2,ciclosDisparo,tiempoCreditos,heroBalasTotales,heroDobleBullets,secret,puntosBonus25,puntosBonus50,vidaBonus,superDisparos,superDisparoActivo,superDisparosTotales;
    private boolean[] musicaApagada;
    private boolean playing,fireOn;
    private boolean cargandoActivo,tiempoFinOn,muerto,tecla,pausa,dobleDisparo,monstruoAnimacion,monstruoAnimacionEstado,teclaIzquierda,teclaDerecha,teclaArriba,teclaAbajo,tiles,gameCpress,superDisparo;
    ...
    void start(int vidasNivel2,int puntosNivel2) {
        int i;
        cargandoActiva();
        // Actualizar la barra de cargar
        cargandoActualiza(2);
        ...
        for (i=1 ; i<=6 ; i++) {
            enemies[i]=new Enemy3(9,getHeight(),getWidth());
        ...
        for (i=1 ; i<=29 ; i++) {
            ...
            aBullet[i].addFrame(5,"/3mydoblebullet.png");
            aBullet[i].addFrame(6,"/2mysuperbullet.png");
            aBullet[i].off();
        ...
        // Explosiones 5
        explode5=new Explode(16);
        explode5.addFrame(1,"/2explode3-1.png");
        explode5.addFrame(2,"/2explode3-2.png");
        explode5.addFrame(3,"/2explode3-3.png");
        explode5.addFrame(4,"/2explode3-4.png");
        explode5.addFrame(5,"/2explode3-5.png");
        explode5.addFrame(6,"/2explode3-6.png");
        explode5.addFrame(7,"/2explode3-7.png");
        explode5.addFrame(8,"/2explode3-8.png");
        explode5.addFrame(9,"/2explode3-9.png");
        explode5.addFrame(10,"/2explode3-10.png");
        explode5.addFrame(11,"/2explode3-11.png");
        explode5.addFrame(12,"/2explode3-12.png");
        explode5.addFrame(13,"/2explode3-13.png");
        explode5.addFrame(14,"/2explode3-14.png");
        explode5.addFrame(15,"/2explode3-15.png");
        explode5.addFrame(16,"/2explode3-16.png");
    ...
    void computeBullets() {
        ...
        if (monster.isActive() && monster.getDeltaX() != 0 && monster.getFrame() == 6) {
            ...
            if (freeBullet !=0) {
                ...
                // Poner el disparo del monstruo1
                musica[9].on(true);
            }
        }
    ...
    public void run(int vidasNivel2,int puntosNivel2) {
	    playing = true;
        ...
        if (playing) {
	        start(vidasNivel2,puntosNivel2);
