...
class Level2 extends GameCanvas {
	...
	private boolean cargandoActivo,tiempoFinOn,muerto,tecla,pausa,ganado,superDisparo,monstruoAnimacion,monstruoAnimacionEstado,teclaIzquierda,teclaDerecha,teclaArriba,teclaAbajo,gameCpress,gameDpress;
