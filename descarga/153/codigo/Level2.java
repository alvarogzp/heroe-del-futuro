...
class Level2 extends GameCanvas {
	...
	private boolean playing,fireOn,cargandoActivo,tiempoFinOn,muerto,tecla,pausa,ganado,superDisparo,monstruoAnimacion,monstruoAnimacionEstado,teclaIzquierda,teclaDerecha,teclaArriba,teclaAbajo,gameCpress,gameDpress,cargarSonido,ganadoForever;
	...
	void cargaMusica() {
		...
		musica[1] = new Sonido("/2backmusic.wav",volumenMusica,cargarSonido);
		cargandoActualiza(11);
		musica[2] = new Sonido("/2monster.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(12);
		...
		musica[5] = new Sonido("/2explode3.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(15);
		musica[6] = new Sonido("/2explodemonster.wav",volumenEfectos,cargarSonido);
		...
		musica[11] = new Sonido("/pickweapon.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(21);
		musica[12] = new Sonido("/2superdisparo.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(22);
		musica[13] = new Sonido("/bonus25.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(23);
		musica[14] = new Sonido("/bonus50.wav",volumenEfectos,cargarSonido);
