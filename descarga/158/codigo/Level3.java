...
class Level3 extends GameCanvas {
	...
	void cargaMusica() {
		musica[1] = new Sonido("/music/3backmusic.wav",volumenMusica,cargarSonido);
		cargandoActualiza(6);
		musica[2] = new Sonido("/music/3monster.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(7);
		...
		cargandoActualiza(9);
		musica[5] = new Sonido("/music/3explode2(2).wav",volumenEfectos,cargarSonido);
		cargandoActualiza(10);
		musica[6] = new Sonido("/music/3explodemonster.wav",volumenEfectos,cargarSonido);
		...
		musica[11] = new Sonido("/music/3explode1(2).wav",volumenEfectos,cargarSonido);
		cargandoActualiza(16);
		musica[12] = new Sonido("/music/pickweapon.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(17);
		musica[13] = new Sonido("/music/2superdisparo.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(18);
		musica[14] = new Sonido("/music/3dobledisparo.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(19);
		musica[15] = new Sonido("/music/3finalmusic.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(20);
		musica[16] = new Sonido("/music/3live.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(21);
		musica[17] = new Sonido("/music/bonus25.wav",volumenEfectos,cargarSonido);
		cargandoActualiza(22);
		musica[18] = new Sonido("/music/bonus50.wav",volumenEfectos,cargarSonido);
			...
			if (introduccion.isActive()) {
				...
				if (cargandoActivo) {
					...
					if (!startAnimacion.isActive()) {
						...
						g.drawString(minutos+":"+segundosPrint,6*getWidth()/10,20,Graphics.HCENTER|Graphics.BOTTOM);
					}
