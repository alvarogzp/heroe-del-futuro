...
class Level2 extends GameCanvas {
	private int score,sleepTime,cicle,lives,shield,indice_in,indice,xTiles,yTiles,deltaX,deltaY,finishLevel,cicloCount,cicloEspera,heroBullets,monsterLives,tiempoFin,sleepTimeStatic,scoreLevel1,ciclosDisparo,tiempoNuevoNivel,superDisparos,superDisparoActivo,superDisparosTotales,puntosBonus25,puntosBonus50;
	private boolean playing,fireOn,cargandoActivo,tiempoFinOn,muerto,tecla,pausa,ganado,superDisparo,monstruoAnimacion,monstruoAnimacionEstado,teclaIzquierda,teclaDerecha,teclaArriba,teclaAbajo,gameCpress,ganadoForever,comprobarPaint;
